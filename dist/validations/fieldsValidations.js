...
exports.prepareDataToBeSaved = exports.areAllFieldsValid = exports.areTagsValid = exports.isContentValid = exports.isSubtitleValid = exports.isTitleValid = void 0;
...
function isSubtitleValid(subtitle) {
...
exports.isSubtitleValid = isSubtitleValid;
...
exports.isContentValid = isContentValid;
...
exports.areTagsValid = areTagsValid;
function areAllFieldsValid(note) {
    return (isTitleValid(note.title) &&
        isSubtitleValid(note.subtitle) &&
        isContentValid(note.content) &&
        areTagsValid(note.tags));
}
exports.areAllFieldsValid = areAllFieldsValid;
function prepareDataToBeSaved(note) {
    return {
        title: note.title,
...
exports.prepareDataToBeSaved = prepareDataToBeSaved;
